...
import app.wgx.com.aiYa.animation.AlphaInAnimation;
import app.wgx.com.aiYa.animation.BaseAnimation;
import app.wgx.com.aiYa.animation.CustomAnimation;
import app.wgx.com.aiYa.animation.ScaleInAnimation;
import app.wgx.com.aiYa.animation.SlideInBottomAnimation;
import app.wgx.com.aiYa.animation.SlideInLeftAnimation;
import app.wgx.com.aiYa.animation.SlideInRightAnimation;

/**
 * Created by imotor on 16-11-23.
 */
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private BaseViewHolder getLoadingView(ViewGroup parent) {
        if (mLoadingView == null) {
            return createBaseViewHolder(parent, R.layout.adapter_def_loading);
        }
